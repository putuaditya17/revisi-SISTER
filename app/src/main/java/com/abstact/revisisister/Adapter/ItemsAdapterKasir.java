...
public class ItemsAdapterKasir extends RecyclerView.Adapter<ItemsAdapterKasir.GridViewHolder> {
    private final ArrayList<Item> itemArrayList = new ArrayList<>();
    private final Activity activity;

    private final SQLiteHelper sqLiteHelper;

    public ItemsAdapterKasir(Activity activity) {
    ...
    public GridViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_items_kasir, parent, false);
